...
export default function AppleSignInButton({ clientId, onSuccess, onError }) {
  ...
  return (
    <button type="button" onClick={handleClick} disabled={loading}
      ...
      className="w-full flex items-center justify-center gap-2.5 bg-black text-white font-semibold py-3 rounded-sm hover:bg-[#1a1a1a] transition-colors disabled:opacity-60 text-base border border-white/10">
