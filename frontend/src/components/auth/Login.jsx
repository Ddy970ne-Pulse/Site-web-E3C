    ...
    <div className="min-h-screen bg-[#0A0A0A] flex flex-col items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-10">
          ...
          <h1 className="font-outfit font-bold text-2xl text-white">Connexion</h1>
        ...
        <div className="bg-[#121212] border border-white/8 p-8">
          {error && (
            <div data-testid="login-error" className="bg-red-500/10 border border-red-500/30 text-red-400 p-3 mb-5 text-sm rounded-sm">
              {error}
            </div>
          )}
