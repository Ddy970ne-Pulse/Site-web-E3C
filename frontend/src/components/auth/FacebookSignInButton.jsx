...
export default function FacebookSignInButton({ onSuccess, onError }) {
  ...
  return (
    <button type="button" onClick={handleClick} disabled={loading}
      ...
      className="w-full flex items-center justify-center gap-2.5 bg-[#1877F2] text-white font-semibold py-3 rounded-sm hover:bg-[#166FE5] transition-colors disabled:opacity-60 text-sm">
