  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        {/* Grille compacte — même style que Prestations */}
          ...
          {values.map((value, i) => {
            ...
            return (
              <div
                ...
                className="group bg-[#0D0D0D] hover:bg-[#131313] transition-colors duration-200 p-5 flex items-start gap-4"
              >
        ...
        <div className="mt-8 flex flex-col sm:flex-row items-center justify-between gap-4 pt-6 border-t border-white/5">
          <div>
            <p className="font-outfit font-semibold text-white text-base">Prêt à démarrer votre projet ?</p>
            <p className="text-gray-500 text-xs mt-0.5">Devis gratuit · Sans engagement · Réponse rapide</p>
          </div>
          <button
