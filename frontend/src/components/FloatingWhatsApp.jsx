...
export default function FloatingWhatsApp({ whatsapp }) {
  ...
  const message = "Bonjour%20E3C%20!%20Je%20souhaite%20un%20devis%20gratuit%20pour%20mes%20travaux.";
  ...
  return (
    <div className="whatsapp-float">
      ...
      <a
        ...
        className="flex items-center justify-center w-14 h-14 rounded-full bg-green-500 text-white shadow-[0_0_20px_rgba(34,197,94,0.5)] hover:scale-110 hover:shadow-[0_0_30px_rgba(34,197,94,0.7)] transition-all duration-300 animate-pulse-glow"
